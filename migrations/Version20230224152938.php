 ...
 */
final class Version20230224152938 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hobi (id INT AUTO_INCREMENT NOT NULL, designation VARCHAR(70) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE personne_hobi (personne_id INT NOT NULL, hobi_id INT NOT NULL, INDEX IDX_1FB57A28E04BE0F5 (hobi_id), INDEX IDX_1FB57A28A21BD112 (personne_id), PRIMARY KEY(personne_id, hobi_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
